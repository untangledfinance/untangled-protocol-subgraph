...
export class Zapper__tranchedPoolZapsResult {
  value0: Address;
  value1: BigInt;
...
export class Zapper extends ethereum.SmartContract {
  static bind(address: Address): Zapper {
    return new Zapper("Zapper", address);
  }
  ...
  tranchedPoolZaps(param0: BigInt): Zapper__tranchedPoolZapsResult {
    let result = super.call(
      "tranchedPoolZaps",
      "tranchedPoolZaps(uint256):(address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new Zapper__tranchedPoolZapsResult(
      result[0].toAddress(),
      result[1].toBigInt()
    );
  }

  try_tranchedPoolZaps(
    param0: BigInt
  ): ethereum.CallResult<Zapper__tranchedPoolZapsResult> {
    let result = super.tryCall(
      "tranchedPoolZaps",
      "tranchedPoolZaps(uint256):(address,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new Zapper__tranchedPoolZapsResult(
        value[0].toAddress(),
        value[1].toBigInt()
      )
    );
...
export class ClaimTranchedPoolZapCall extends ethereum.Call {
  get inputs(): ClaimTranchedPoolZapCall__Inputs {
    return new ClaimTranchedPoolZapCall__Inputs(this);
  }

  get outputs(): ClaimTranchedPoolZapCall__Outputs {
    return new ClaimTranchedPoolZapCall__Outputs(this);
  }
}

export class ClaimTranchedPoolZapCall__Inputs {
  _call: ClaimTranchedPoolZapCall;

  constructor(call: ClaimTranchedPoolZapCall) {
    this._call = call;
  }
...
export class ClaimTranchedPoolZapCall__Outputs {
  _call: ClaimTranchedPoolZapCall;
...
export class UnzapToStakingRewardsCall extends ethereum.Call {
  get inputs(): UnzapToStakingRewardsCall__Inputs {
    return new UnzapToStakingRewardsCall__Inputs(this);
  }

  get outputs(): UnzapToStakingRewardsCall__Outputs {
    return new UnzapToStakingRewardsCall__Outputs(this);
  }
}

export class UnzapToStakingRewardsCall__Inputs {
  _call: UnzapToStakingRewardsCall;

  constructor(call: UnzapToStakingRewardsCall) {
    this._call = call;
  }
...
export class UnzapToStakingRewardsCall__Outputs {
  _call: UnzapToStakingRewardsCall;
...
export class ZapStakeToCurveCall extends ethereum.Call {
  get inputs(): ZapStakeToCurveCall__Inputs {
    return new ZapStakeToCurveCall__Inputs(this);
  }

  get outputs(): ZapStakeToCurveCall__Outputs {
    return new ZapStakeToCurveCall__Outputs(this);
  }
}

export class ZapStakeToCurveCall__Inputs {
  _call: ZapStakeToCurveCall;

  constructor(call: ZapStakeToCurveCall) {
    this._call = call;
  }
...
export class ZapStakeToCurveCall__Outputs {
  _call: ZapStakeToCurveCall;
...
export class ZapStakeToTranchedPoolCall extends ethereum.Call {
  get inputs(): ZapStakeToTranchedPoolCall__Inputs {
    return new ZapStakeToTranchedPoolCall__Inputs(this);
  }

  get outputs(): ZapStakeToTranchedPoolCall__Outputs {
    return new ZapStakeToTranchedPoolCall__Outputs(this);
  }
}

export class ZapStakeToTranchedPoolCall__Inputs {
  _call: ZapStakeToTranchedPoolCall;

  constructor(call: ZapStakeToTranchedPoolCall) {
    this._call = call;
  }
...
export class ZapStakeToTranchedPoolCall__Outputs {
  _call: ZapStakeToTranchedPoolCall;
