...
export class GrantRevoked extends ethereum.Event {
  get params(): GrantRevoked__Params {
    return new GrantRevoked__Params(this);
  }
}

export class GrantRevoked__Params {
  _event: GrantRevoked;

  constructor(event: GrantRevoked) {
    this._event = event;
  }
...
export class CommunityRewards__grantsResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
  ...
  getCliffLength(): BigInt {
    return this.value4;
  }

  getVestingInterval(): BigInt {
    return this.value5;
  }
...
export class CommunityRewards extends ethereum.SmartContract {
  static bind(address: Address): CommunityRewards {
    return new CommunityRewards('CommunityRewards', address);
  }
  ...
  grant(
    ...
    let result = super.call(
      'grant',
      'grant(address,uint256,uint256,uint256,uint256):(uint256)',
      [
        ethereum.Value.fromAddress(recipient),
        ethereum.Value.fromUnsignedBigInt(amount),
        ethereum.Value.fromUnsignedBigInt(vestingLength),
        ethereum.Value.fromUnsignedBigInt(cliffLength),
        ethereum.Value.fromUnsignedBigInt(vestingInterval),
      ]
    );
  ...
  grants(param0: BigInt): CommunityRewards__grantsResult {
    let result = super.call(
      'grants',
      'grants(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)',
      [ethereum.Value.fromUnsignedBigInt(param0)]
    );

    return new CommunityRewards__grantsResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_grants(
    param0: BigInt
  ): ethereum.CallResult<CommunityRewards__grantsResult> {
    let result = super.tryCall(
      'grants',
      'grants(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)',
      [ethereum.Value.fromUnsignedBigInt(param0)]
    ...
    return ethereum.CallResult.fromValue(
      new CommunityRewards__grantsResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt(),
        value[3].toBigInt(),
  ...
  isDistributor(): boolean {
    let result = super.call('isDistributor', 'isDistributor():(bool)', []);

    return result[0].toBoolean();
  }

  try_isDistributor(): ethereum.CallResult<boolean> {
    let result = super.tryCall('isDistributor', 'isDistributor():(bool)', []);
    if (result.reverted) {
      return new ethereum.CallResult();
    }
    let value = result.value;
  ...
  tokenLaunchTimeInSeconds(): BigInt {
    let result = super.call(
      'tokenLaunchTimeInSeconds',
      'tokenLaunchTimeInSeconds():(uint256)',
      []
    );
  ...
  try_tokenLaunchTimeInSeconds(): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      'tokenLaunchTimeInSeconds',
      'tokenLaunchTimeInSeconds():(uint256)',
      []
  ...
  totalUnclaimed(owner: Address): BigInt {
    let result = super.call(
      'totalUnclaimed',
  ...
  try_totalUnclaimed(owner: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      'totalUnclaimed',
      'totalUnclaimed(address):(uint256)',
      [ethereum.Value.fromAddress(owner)]
  ...
  totalVestedAt(
    ...
    let result = super.call(
      'totalVestedAt',
      'totalVestedAt(uint256,uint256,uint256,uint256,uint256,uint256,uint256):(uint256)',
      [
        ethereum.Value.fromUnsignedBigInt(start),
        ethereum.Value.fromUnsignedBigInt(end),
        ethereum.Value.fromUnsignedBigInt(granted),
        ethereum.Value.fromUnsignedBigInt(cliffLength),
        ethereum.Value.fromUnsignedBigInt(vestingInterval),
  ...
  unclaimed(tokenId: BigInt): BigInt {
    let result = super.call('unclaimed', 'unclaimed(uint256):(uint256)', [
      ethereum.Value.fromUnsignedBigInt(tokenId),
    ]);
  ...
  try_unclaimed(tokenId: BigInt): ethereum.CallResult<BigInt> {
    let result = super.tryCall('unclaimed', 'unclaimed(uint256):(uint256)', [
      ethereum.Value.fromUnsignedBigInt(tokenId),
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
...
export class __initialize__Call__Inputs {
  ...
  get _tokenLaunchTimeInSeconds(): BigInt {
...
export class RevokeGrantCall extends ethereum.Call {
  get inputs(): RevokeGrantCall__Inputs {
    return new RevokeGrantCall__Inputs(this);
  }

  get outputs(): RevokeGrantCall__Outputs {
    return new RevokeGrantCall__Outputs(this);
  }
}

export class RevokeGrantCall__Inputs {
  _call: RevokeGrantCall;

  constructor(call: RevokeGrantCall) {
    this._call = call;
  }
...
export class RevokeGrantCall__Outputs {
  _call: RevokeGrantCall;
...
export class SetTokenLaunchTimeInSecondsCall extends ethereum.Call {
  get inputs(): SetTokenLaunchTimeInSecondsCall__Inputs {
    return new SetTokenLaunchTimeInSecondsCall__Inputs(this);
  }

  get outputs(): SetTokenLaunchTimeInSecondsCall__Outputs {
    return new SetTokenLaunchTimeInSecondsCall__Outputs(this);
  }
}

export class SetTokenLaunchTimeInSecondsCall__Inputs {
  _call: SetTokenLaunchTimeInSecondsCall;

  constructor(call: SetTokenLaunchTimeInSecondsCall) {
    this._call = call;
  }
...
export class SetTokenLaunchTimeInSecondsCall__Outputs {
  _call: SetTokenLaunchTimeInSecondsCall;
