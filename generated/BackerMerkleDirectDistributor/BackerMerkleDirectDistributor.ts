...
export class BackerMerkleDirectDistributor extends ethereum.SmartContract {
  static bind(address: Address): BackerMerkleDirectDistributor {
    return new BackerMerkleDirectDistributor(
