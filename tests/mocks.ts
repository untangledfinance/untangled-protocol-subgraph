...
import {
  CONFIG_KEYS_NUMBERS,
  UNTANGLED_CONFIG_ADDRESS,
  UNTANGLED_LEGACY_CONFIG_ADDRESS,
  POOL_TOKENS_ADDRESS,
  SENIOR_POOL_ADDRESS,
  FIDU_ADDRESS,
...
export function mockTranchedPoolMultipleSlicesCalls(
  ...
  const defaultPrincipalDeposited = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromI32(0)
  );
  const defaultPrincipalSharePrice = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromI32(0)
  );
  const defaultInterestSharePrice = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromI32(0)
  );
  const lockedUntil = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromI32(1635209769)
  );
  const interestSharePrice = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('9611500737600000')
  );
  const principalDeposited = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString(jrPrincipalDeposited)
  );
  const principalSharePrice = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('736000000')
  );
  createMockedFunction(
    tranchedPoolAddress,
    'getTranche',
...
export function mockTranchedPoolCalls(
  ...
  const juniorFeePercent = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromI32(20)
  );
  const reserveDenominator = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromI32(10)
  );
  const rawLeverageRatio = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromU64(3000000000000000000)
  );
  const estimatedSeniorPoolContribution = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('15000000000000')
  );
  ...
  createMockedFunction(
    Address.fromString(UNTANGLED_CONFIG_ADDRESS),
    'getNumber',
    'getNumber(uint256):(uint256)'
  )
    .withArgs([
      ethereum.Value.fromUnsignedBigInt(
        BigInt.fromString(CONFIG_KEYS_NUMBERS.LeverageRatio.toString())
      ),
    ])
    .returns([rawLeverageRatio]);

  createMockedFunction(
    Address.fromString(UNTANGLED_LEGACY_CONFIG_ADDRESS),
    'getNumber',
    'getNumber(uint256):(uint256)'
  )
    .withArgs([
  ...
  createMockedFunction(
    ...
    .withArgs([
      ethereum.Value.fromUnsignedBigInt(
        BigInt.fromString(CONFIG_KEYS_NUMBERS.ReserveDenominator.toString())
      ),
    ])
  ...
  createMockedFunction(
    Address.fromString(UNTANGLED_CONFIG_ADDRESS),
    'getAddress',
    'getAddress(uint256):(address)'
  )
    .withArgs([
      ethereum.Value.fromUnsignedBigInt(
        BigInt.fromString(CONFIG_KEYS_ADDRESSES.BackerRewards.toString())
      ),
    ])
...
export function mockCreditLineContractCalls(
  ...
  const balance = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString(defaultBalance)
  );
  const interestApr = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('130000000000000000')
  );
  const interestAccruedAsOf = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('1637515148')
  );
  const paymentPeriodInDays = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('30')
  );
  const termInDays = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('730')
  );
  const nextDueTime = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('1640107148')
  );
  const limit = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('5000000000000')
  );
  const maxLimit = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('10000000000000')
  );
  const interestOwed = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('0')
  );
  const termStartTime = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('1634923148')
  );
  const termEndTime = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('1697995148')
  );
  const lastFullPaymentTime = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('1637515148')
  );
  const isLate = ethereum.Value.fromBoolean(false);
  const borrower = ethereum.Value.fromAddress(
    Address.fromString('0xd750033cd9ab91ead99074f671bbcbce0ffd91a8')
  );
  ...
  createMockedFunction(creditLineAddress, 'isLate', 'isLate():(bool)')
    .withArgs([])
    .returns([isLate]);
  createMockedFunction(creditLineAddress, 'borrower', 'borrower():(address)')
    .withArgs([])
    .returns([borrower]);
  createMockedFunction(
    creditLineAddress,
...
export function mockPoolBackersContractCalls(
  ...
  const interestRedeemable = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString(defaultRedeemable)
  );
  const principalRedeemable = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString(defaultRedeemable)
  );
  createMockedFunction(
    tranchedPoolAddress,
...
export function mockTranchedPoolTokenContractCalls(
  ...
  const principalAmount = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('5000000000000')
  );
  const principalRedeemed = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString(defaultPrincipalRedeemed)
  );
  const interestRedeemed = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('0')
  );
...
export function mockUpdatePoolStatusCalls(seniorPoolAddress: string): void {
  const amount = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('5000000000000')
  );
  ...
  createMockedFunction(
    ...
    .withArgs([
      ethereum.Value.fromAddress(Address.fromString(seniorPoolAddress)),
    ])
    .returns([amount]);
}

export function mockUpdateUserCalls(
  seniorPoolAddress: Address,
  capitalProviderAddress: Address
): void {
  const amount = ethereum.Value.fromUnsignedBigInt(
    BigInt.fromString('5000000000000')
  );
  ...
  createMockedFunction(
    ...
    .withArgs([
      ethereum.Value.fromAddress(capitalProviderAddress),
      ethereum.Value.fromAddress(seniorPoolAddress),
    ])
    .returns([amount]);
