...
import { UntangledConfig } from '../generated/UntangledConfig/UntangledConfig';
...
export function getAddressFromConfig<T extends ConfigBearer>(
  ...
  const untangledConfigContract = UntangledConfig.bind(contract.config());
  return untangledConfigContract.getAddress(BigInt.fromI32(target));
}
